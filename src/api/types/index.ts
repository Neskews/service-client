...
export const GET_OFFERS: string = 'Request a list of offers';
export const GET_OFFERS_SUCCESS: string =
  'Successfully requested a list of offers';
export const GET_OFFERS_FAILED: string = 'Requesting a list of offers failed';

export const INCREASE_PERSON_POINTS: string =
  'Increase the points for a person';
export const INCREASED_PERSON_POINTS_SUCCESSFULLY: string =
  'Successfully increased the points for a perspon';
